...
import com.emoji.ftp.databinding.FragmentClientSftpBinding
import com.emoji.ftp.databinding.ItemListFileBinding
import com.emoji.ftp.databinding.ItemListNameBinding
import com.emoji.ftp.databinding.ItemSortNameBinding
import com.emoji.ftp.databinding.PopupWindowBottomBinding
import com.emoji.ftp.databinding.PopupWindowSortFileBinding
import com.emoji.ftp.event.ClientMessageEvent
import com.emoji.ftp.player.playSftpVideo
import com.emoji.ftp.provider.GetProvider
import com.emoji.ftp.service.ClientType
import com.emoji.ftp.service.SftpClientService
import com.emoji.ftp.service.TempFileDownload
import com.emoji.ftp.ui.MainViewModel
import com.emoji.ftp.ui.dialog.PickFilesDialog
import com.emoji.ftp.ui.format
import com.emoji.ftp.ui.player.FullPlayerActivity
import com.emoji.ftp.ui.toReadableFileSize
import com.emoji.ftp.ui.toReadableFileSizeFormat1
import com.emoji.ftp.utils.DisplayUtils
import com.emoji.ftp.utils.MySPUtil
import com.emoji.ftp.utils.deleteDirectory
import com.emoji.ftp.utils.ensureLocalDirectoryExists
import com.emoji.ftp.utils.formatTimeWithSimpleDateFormat
import com.emoji.ftp.utils.getIcon4File
import com.emoji.ftp.utils.isFileNameValid
...
import com.emoji.ftp.utils.openFileWithSystemApp
import com.emoji.ftp.utils.showCustomAlertDialog
import com.emoji.ftp.utils.showCustomFileInfoDialog
import com.emoji.ftp.utils.showCustomInputDialog
import com.emoji.ftp.utils.showCustomLoadingDialog
import com.emoji.ftp.utils.showCustomPlayerDialog
import com.emoji.ftp.utils.showToast
import com.emoji.ftp.utils.sortFiles
