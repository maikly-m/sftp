...
public class LoadingDialog extends DialogFragment {
    ...
    protected DialogLoadingBinding mBinding;
    ...
    public LoadingDialog (boolean outCancel) {
        mOutCancel = outCancel;
    }

    public static LoadingDialog newInstance (boolean outCancel) {
        return new LoadingDialog(outCancel);
    }
